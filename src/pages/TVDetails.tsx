    ...
    <div className="font-sans">
      ...
      <div className="p-4 font-sans">
        <div className="flex flex-col md:flex-row gap-6 w-full items-stretch">
          ...
          {/* Right card: seasons */}
          <div className="flex-1 bg-gray-100 rounded-xl shadow p-6 flex flex-col gap-2 min-w-[140px] max-w-full overflow-y-auto scrollbar-hide self-stretch" style={cardHeight ? {height: cardHeight} : {}}>
            {show.seasons && show.seasons.length > 0 && (
              <div className="mt-0">
                <h3 className="font-bold text-lg mb-2">Seasons</h3>
                <ul className="space-y-2">
                  {show.seasons.map((season: any) => (
                    <li key={season.id} className="bg-white rounded-lg shadow p-2 flex flex-col">
                      {season.poster_path && (
                        <img
